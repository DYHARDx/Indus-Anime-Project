...
public class VideoplayerActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview13.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				_Download(getIntent().getStringExtra("Url"), "/Indus Anime/".concat(getIntent().getStringExtra("filename").concat("/")));
			}
		});
		...
		imageview14.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (lock) {
					...
					imageview14.setImageResource(R.drawable.ic_lock_white);
		...
		zooom.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				if (zoom == 2) {
					...
					zoomtype.setText("FIT TO SCREEN");
				}
				if (zoom == 3) {
