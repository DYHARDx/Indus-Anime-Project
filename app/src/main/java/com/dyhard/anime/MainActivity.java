		...
		_update_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.contains("update")) {
					lntent.putExtra("Download", _childValue.get("Download").toString());
					lntent.setClass(getApplicationContext(), UpdateAppActivity.class);
					lntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		_maintanence_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childValue.get("maintanence").toString().equals("on")) {
					lntent.setClass(getApplicationContext(), MaintanenceActivity.class);
					lntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(lntent);
					finish();
				}
		...
		timer = new TimerTask() {
			...
			public void run() {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						lntent.setClass(getApplicationContext(), InicioActivity.class);
						startActivity(lntent);
						_fade_translate();
						finish();
					}
